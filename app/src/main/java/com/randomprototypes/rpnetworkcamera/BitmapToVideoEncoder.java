...
/**
 * code from https://stackoverflow.com/questions/17096726/how-to-encode-bitmaps-into-a-video-using-mediacodec
 * OldSchool4664, shervinox
 */
...
public class BitmapToVideoEncoder {
    ...
    private static final int BIT_RATE = 125000;//16000000;
    ...
    public void startEncoding(int width, int height, File outputFile) {
        ...
        Log.d(TAG, "selected format"+colorFormat);
    ...
    public void queueFrame(byte[] bitmap) {
        if (mediaCodec == null || mediaMuxer == null) {
    ...
    private void encode() {
        ...
        while(true) {
            ...
            //byte[] byteConvertFrame = convertToByteArray(bitmap);//getNV21(bitmap.getWidth(), bitmap.getHeight(), bitmap);
            byte[] byteConvertFrame = bitmap;//getNV21(bitmap.getWidth(), bitmap.getHeight(), bitmap);
